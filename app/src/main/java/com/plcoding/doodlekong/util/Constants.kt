...
object Constants {
    const val HTTP_BASE_URL_LOCALHOST = "http://192.168.1.5:8080"
//    const val HTTP_BASE_URL_LOCALHOST = "http://0.0.0.0:8080"
    const val WS_BASE_URL_LOCALHOST = "http://192.168.1.5:8080/ws/draw"

    const val DEFAULT_PAINT_THICKNESS: Float = 11f
